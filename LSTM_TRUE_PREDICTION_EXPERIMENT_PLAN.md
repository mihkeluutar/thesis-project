...
- Target: harmonised comfort-heating target (`heat_target_mwh`) exported by `01_thesis_data_pipeline_09032026.ipynb`.
...
- Primary window: heating-season rows (`T_out < 15.0°C`).
- Secondary window: all-hours.
- Primary metrics: RMSE, R².
- Secondary metrics: MAE, WAPE.
...
- `results/true_prediction/summary.md`
  - Core vs extended portfolio tables, model ranking by RMSE (+R² companion), and U06/U05 deep-dive figures.
